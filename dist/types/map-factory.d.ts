...
export declare type TypeMap<I extends object = any, O extends object = any> = {
    [key in keyof O]: boolean | keyof I | PropertyFactory<I, O, key> | PropertyMapper<I, O, key> | PropertyConverter<I, O, key>;
};
export declare type InferOutput<I extends object, T extends TypeMap<I, O>, O extends object = any> = {
    [key in keyof T]-?: T[key] extends true ? I[Extract<key, keyof I>] : T[key] extends keyof I ? I[T[key]] : T[key] extends PropertyFactory<I, O, infer K> ? O[K] : T[key] extends Converter<I, infer OT> ? OT : T[key] extends Partial<Record<string, infer OT>> ? OT extends Converter<any, infer OKT> ? OKT : never : T[key] extends readonly [Converter<any, infer R>] ? R : never;
};
