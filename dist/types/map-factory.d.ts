...
export declare function mapFactory<I extends object>(): <F extends TypeMap<I, any>, O extends object = InferOutput<I, F>>(fieldMap: F) => Converter<I, O>;
...
export declare type InferOutput<I extends object, T extends TypeMap<I, O>, O extends object = any> = {
    [key in keyof T]-?: T[key] extends true ? I[Extract<key, keyof I>] : T[key] extends keyof I ? I[T[key]] : T[key] extends Converter<I, infer OT> ? OT : T[key] extends Partial<Record<string, infer OT>> ? OT extends Converter<any, infer OKT> ? OKT : never : never;
};
