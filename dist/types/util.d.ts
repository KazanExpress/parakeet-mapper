...
export declare type PropertyMapper<I extends object, O extends object, key extends keyof O, ikey extends keyof I = Extract<key, keyof I>> = EitherField<Partial<InternalPropertyMapper<I, O, key>>> | (ikey extends keyof I ? {
